...
export function createInteractionBenchmarks(scene) {
  ...
  const targets = {
    ...
    PICK_UP_CUP: {
      ...
      get lookAt() { return worldPoint(cup) },
      get contactPoint() { return worldPoint(cup) },
      get gripPoint() { return worldPoint(cup, new THREE.Vector3(0.045, 0.01, 0)) },
      object: cup,
      hand: "right",
      type: "small-one-hand",
    },
    PICK_UP_PHONE: {
      ...
      get gripPoint() { return worldPoint(phone) },
      object: phone,
      hand: "right",
      secondaryHand: "left",
      type: "phone-grip",
    ...
    SIT_SOFA: {
      ...
      footLeft: new THREE.Vector3(-2.18, 0.02, -0.02),
      footRight: new THREE.Vector3(-1.82, 0.02, -0.02),
  ...
  return { root, targets, objects: { wall, sofa, sofaBack, cup, phone, magazine, door, handle, doorPivot, bell } }
}
